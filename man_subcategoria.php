  ...
  <article style="margin-top:10px; margin-left:15px;">
    <div class="row">
      ...
      <strong style="font-size:14px;">Informaci&oacute;n General</strong>
        <div class="recuadro">
          <form action="add_problemas.php" id="add_subcategoria" method="post">
              <!-- Categoria -->
              ...
              <div class="input-group input-group-sm" style="margin-bottom:5px;">
                ...
                <input type="text" id="sub" name="sub" class="form-control" placeholder="Escriba una sub categoria" onkeyup="validar('sub');"  aria-describedby="basic-addon1">
